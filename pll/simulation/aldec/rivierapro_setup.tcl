...
alias com {
  ...
  vlog -v2k5 "$QSYS_SIMDIR/submodules/pll_video_pll_0_video_pll.vo"                -work video_pll        
  vlog -v2k5 "$QSYS_SIMDIR/submodules/pll_video_pll_0.v"                           -work video_pll_0      
  vlog -v2k5 "$QSYS_SIMDIR/pll.v"                                                                         
}

...
# ACDS 15.0 145 win32 2016.02.29.15:09:33
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog "$QSYS_SIMDIR/submodules/pll_video_pll_0_video_pll.vo"                -work video_pll         -cdslib ./cds_libs/video_pll.cds.lib        
  ncvlog "$QSYS_SIMDIR/submodules/pll_video_pll_0.v"                           -work video_pll_0       -cdslib ./cds_libs/video_pll_0.cds.lib      
  ncvlog "$QSYS_SIMDIR/pll.v"                                                                                                                      
fi

...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k "$QSYS_SIMDIR/submodules/pll_video_pll_0_video_pll.vo"                -work video_pll        
  vlogan +v2k "$QSYS_SIMDIR/submodules/pll_video_pll_0.v"                           -work video_pll_0      
  vlogan +v2k "$QSYS_SIMDIR/pll.v"                                                                         
fi

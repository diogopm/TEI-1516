...
# ACDS 15.0 145 win32 2016.02.29.15:09:32
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "D:/altera/15.0/quartus/"
}
...
alias com {
  ...
  vlog "$QSYS_SIMDIR/submodules/pll_video_pll_0_video_pll.vo"                -work video_pll        
  vlog "$QSYS_SIMDIR/submodules/pll_video_pll_0.v"                           -work video_pll_0      
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L reset_from_locked -L video_pll -L video_pll_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L reset_from_locked -L video_pll -L video_pll_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
